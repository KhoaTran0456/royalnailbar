...
function loadDataForIndex(cgf) {
	...
	var strTopChoiceElement = '<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.0s">' +
		...
		'                                <a href="https://www.facebook.com/royalnailbar.ca" data-facebook target="_blank"><i class="fab fa-facebook-f"></i></a>' +
		'                                <a href="https://www.instagram.com/royalnailbarhayward" data-instagram target="_blank"><i class="fab fa-instagram"></i></a>' +
		'                                <a href="https://goo.gl/maps/tWzBj9hpGWTmLNeN6" data-google target="_blank" class="no-border"><i' +
		...
		$.each(cgf.services, function (count1, srv) {
			...
			if (srv.category == cat.name) {
				...
				if (countCat % 2 == 1) {
					...
					strServiceRight = strServiceRight + strServiceElement.replace('SERVICE_NAME', srv.name).replace('SERVICE_PRICE', "$" + srv.price + (srv.plus ? " Up" : ""));
				}
			}
		});
...
function loadDataForSpecialties(cgf) {
	...
	'                                    <a href="https://www.facebook.com/royalnailbar.ca" data-facebook target="_blank"><i class="fab fa-facebook-f"></i></a>'+
	'                                    <a href="https://www.instagram.com/royalnailbarhayward" data-instagram target="_blank"><i class="fab fa-instagram"></i></a>'+
	'                                    <a href="https://goo.gl/maps/tWzBj9hpGWTmLNeN6" data-google target="_blank" class="no-border"><i class="fab fa-google"></i></a>'+
	'                                </div>'+
	'                            </div>'+
	'                        </div>'+
	'                    </div>';
